...
export default function Masuk() {
  return (
    <>
      ...
      <main className="grid h-screen min-h-fit grid-cols-1 items-center bg-gradient-to-br from-[#f4f8fb] to-[#e0f2fe] px-6 py-16 lg:grid-cols-2 lg:px-32 lg:pt-60 lg:pb-48">
        <Form />
