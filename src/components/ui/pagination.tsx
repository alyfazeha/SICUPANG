...
function PaginationLink({ className, isActive, size = "icon", asChild, ...props }: { isActive?: boolean; asChild?: boolean } & Pick<ComponentProps<typeof Button>, "size"> & ComponentProps<"a">) {
